...
### Added
- Existing tab, URL, and domain title rules can now be edited inline from the Settings page.

## [3.0.3] - 2026-08-23

### Changed
- Refined the popup and Options page with the shared Browser Tools visual foundations: cleaner flat surfaces, calmer indigo accents, tighter typography, and consistent light and dark themes.
- Rebuilt the product and toolbar icons from checked-in SVG masters, with deterministic generated PNG assets and an optically tuned 16px toolbar mark.
- Clarified the privacy policy around exact-URL and domain rules, Chrome Sync storage, optional bookmark-title fallback, and incognito persistence.

### Permissions
- No permissions or host access changed in this update.
